...
void readConfiguration( char const*  iniFilename, tConfig *cfg) {
  const size_t bufferLen = 80;
  char buffer[bufferLen];


  SPIFFSIniFile ini(iniFilename); 
